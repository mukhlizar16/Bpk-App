                                ...
                                @foreach ($kontraks as $kontrak)
                                    <tr>
                                        ...
                                        <td class="text-nowrap text-end">Rp.
                                            {{ number_format($kontrak->jumlah, 0, ',', '.') }}</td>
                                        ...
                                        <td>
                                            @if ($kontrak->dokumen)
                                                <a class="btn btn-outline-primary text-nowrap" data-bs-toggle="tooltip"
                                                    title="Unduh" href="{{ asset('storage/' . $kontrak->dokumen) }}"
                                    ...
                                    <x-form_modal>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('pagu_id') is-invalid @enderror"
                                                ...
                                                value="{{ old('pagu_id', $kontrak->pagu_id) }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control @error('penyedia') is-invalid @enderror" id="penyedia"
                                                name="penyedia" value="{{ old('penyedia', $kontrak->penyedia) }}" required>
                                            @error('penyedia')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date"
                                                ...
                                                name="tanggal"
                                                value="{{ old('tanggal', $kontrak->tanggal->format('Y-m-d')) }}" required>
                                            @error('tanggal')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                name="jumlah" value="{{ old('jumlah', $kontrak->jumlah) }}">
                                            @error('jumlah')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('jangka_waktu', $kontrak->jangka_waktu) }}" required>
                                            @error('jangka_waktu')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                name="dokumen" value="{{ old('dokumen', $kontrak->dokumen) }}">
                                            @error('dokumen')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
